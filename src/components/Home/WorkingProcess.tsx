...
export default function WorkingProcess() {
  return (
    <section className="w-full bg-navbg text-center text-white  h-[1800px]  sm:h-[900px]  lg:h-[600px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 max-w-7xl mx-auto h-[1800px] hover:h-[1800px]  sm:h-[900px]  sm:hover:h-[900px]  lg:hover:h-[600]">
