...
export default function HeroSection() {
  ...
  <div className="text-left max-w-3xl mx-auto  text-white">
    ...
    <AnimateOnView variants={fadeLeft}>
      <Link href="#contact">
        <button className="mt-8 bg-transparent text-xl border border-cyan text-white font-semibold py-3 px-6 rounded hover:bg-cyan hover:border-white transition">
